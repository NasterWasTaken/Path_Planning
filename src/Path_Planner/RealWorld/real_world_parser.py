...
from RealWorld.nodesOptimization.SimulatedAnnealing import SimulatedAnnealing
from RealWorld.nodesOptimization.Rotate import Rotate
...
class real_world:
    ...
    def geo2cart(self):
        ...
        for i in range(len(self.obstNED)):
            cartObst[i] = self.rotate.rotatePolygon(self.obstNED[i]) #type: ignore
        ...
        elif megaNodesIn < self.droneNum:
